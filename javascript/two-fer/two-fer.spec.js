...
describe('Two Fer', function () {
    ...
    it('gives one to you, if null is given', function () {
        expect(twoFer.twoFer(null)).toEqual('One for you, one for me.');
    });

    it('gives one to you, if empty string is given', function () {
        expect(twoFer.twoFer('')).toEqual('One for you, one for me.');
    });
});
